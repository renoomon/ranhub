...
(function (CS) {
  ...
  function emptyFeedHtml() {
    ...
    if (tab === 'foryou') {
      ...
      return '<b>✨ For You — ما وصل شي فوق ' + CS.feed.FORYOU_MIN + '٪</b>' +
        '<p>عندك ' + n + ' عمل بـ👍، لكن ترشيحات TMDB لها ما فيها شي تطابقه ذوقك بنسبة ' +
        CS.feed.FORYOU_MIN + '٪ فما فوق بهذي الفلاتر. ما ننزّل العتبة عشان الرقم يبقى صادقًا — ' +
        'صوّت على أعمال أكثر أو وسّع «اللغة الأصلية» و«أقل تقييم».</p>' +
        '<div style="margin-top:1.2rem"><button class="btn" data-go-general>🌹 روح لقسم General</button></div>';
    }
